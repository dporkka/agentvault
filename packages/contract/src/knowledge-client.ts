...
export interface KnowledgeClient {
  ...
  /** Scoped tokens may omit approvedBy; the server binds their persistent principal ID. */
  ...
  /** Scoped tokens may omit actor; the server binds their persistent principal ID. */
