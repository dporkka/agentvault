      ...
      <div className="border-b border-vault-border px-6 py-4">
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            ...
            className="flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg border border-vault-border text-vault-text-secondary hover:bg-vault-bg-hover hover:text-vault-text-primary transition-colors"
          >
